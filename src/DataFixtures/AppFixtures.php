...
class AppFixtures extends Fixture
{
    ...
    {
        // Create languages with duplicate check
        ...
        $spanish = $manager->getRepository(Language::class)->findOneBy(['code' => 'es']);
        if (!$spanish) {
        ...
        $german = $manager->getRepository(Language::class)->findOneBy(['code' => 'de']);
        if (!$german) {
            $german = new Language();
            $german->setCode('de')
                ->setName('Allemand')
