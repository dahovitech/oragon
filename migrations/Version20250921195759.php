 ...
 */
final class Version20250921195759 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE service_media (service_id INTEGER NOT NULL, media_id INTEGER NOT NULL, PRIMARY KEY(service_id, media_id), CONSTRAINT FK_C35E4CEBED5CA9E6 FOREIGN KEY (service_id) REFERENCES services (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C35E4CEBEA9FDD75 FOREIGN KEY (media_id) REFERENCES media (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX IDX_C35E4CEBED5CA9E6 ON service_media (service_id)');
        $this->addSql('CREATE INDEX IDX_C35E4CEBEA9FDD75 ON service_media (media_id)');
